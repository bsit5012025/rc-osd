...
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (51, 'EMP-003', 5, TO_DATE('2025-01-12', 'YYYY-MM-DD'), 2, TO_DATE('2025-01-20', 'YYYY-MM-DD'), 'Caught holding hands', 'PENDING');
...
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (88, 'EMP-002', 8, TO_DATE('2025-01-13', 'YYYY-MM-DD'), 2, TO_DATE('2025-01-17', 'YYYY-MM-DD'), 'Repeatedly late to class', 'PENDING');
...
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (4, 'EMP-003', 2, TO_DATE('2024-08-15', 'YYYY-MM-DD'), 2, TO_DATE('2024-08-16', 'YYYY-MM-DD'), 'Punched his classmate', 'PENDING');
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (7, 'EMP-003', 17, TO_DATE('2024-10-01', 'YYYY-MM-DD'), 2, TO_DATE('2024-10-05', 'YYYY-MM-DD'), 'Not wearing proper uniform', 'PENDING');
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (10, 'EMP-003', 17, TO_DATE('2024-08-20', 'YYYY-MM-DD'), 2, TO_DATE('2024-08-20', 'YYYY-MM-DD'), 'Heard cursing', 'PENDING');
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (13, 'EMP-003', 9, TO_DATE('2025-01-20', 'YYYY-MM-DD'), 2, TO_DATE('2025-01-23', 'YYYY-MM-DD'), 'Using her phone during discussion', 'PENDING');
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (16, 'EMP-003', 8, TO_DATE('2024-11-14', 'YYYY-MM-DD'), 2, TO_DATE('2024-11-17', 'YYYY-MM-DD'), 'Always late to class', 'PENDING');
INSERT INTO record (enrollmentID, employeeID, offenseID, dateOfViolation, actionID, dateOfResolution, remarks, status) VALUES (19, 'EMP-003', 3, TO_DATE('2025-04-09', 'YYYY-MM-DD'), 2, TO_DATE('2025-04-09', 'YYYY-MM-DD'), 'Stealing money', 'PENDING');
